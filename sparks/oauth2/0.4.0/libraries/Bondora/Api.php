...
//        		'secondary' => $json->Payload,
    ...
    private function query($resource, $id=null, $params=null, $method='G/') {
        ...
        $client = get_instance()->oauth2->client("Client", $url, $params, $method, $headers);
